"""RL 환경 인터페이스 스키마 - Sinergym datacenter-mixed-continuous-stochastic-v1 환경 기반"""
# obs/action 인덱스 매핑 정의

from pydantic import BaseModel, Field

# Sinergym obs 28개 중 래퍼가 사용할 인덱스 매핑
...
OBS_INDEX = {
    ...
    "outdoor_humidity":             4,
    "east_zone_air_temperature":    14,
    "west_zone_air_temperature":    13,
    "west_zone_clg_setpoint":       11,
    "HVAC_electricity_demand_rate": 27,
}
...
class RLState(BaseModel):
    ...
    west_zone_clg_setpoint: float = Field(..., description="West Zone 냉각 설정값 (°C)")
